...
<template>
    <div style="perspective: 1000px">
        <div class="p-0.5 rounded bg-none hover:bg-teal-400 transition duration-200 ease-linear transform-gpu group w-full"
            @mouseleave="resetStyle" @mousemove="handleMouseMove" ref="target">
            <div class="rounded p-4 bg-black cursor-default hover:bg-gray-900 text-gray-500 group-hover:text-white">
                <div>
                    ...
                    <a class="text-inherit group-hover:text-teal-500 underline-offset-4 no-underline group-hover:underline group/link"
                        :href="link" target="_blank">
                        <ArrowRight class="inline-block mr-2 group-hover/link:mr-1 transition-all" />Go there
                    </a>
                </div>
            </div>
        </div>
